...
<body>
    <nav class="navbar fixed-top navbar-expand-sm navbar-dark bg-dark">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item active">
                <a href="ListCar-fasma.php" class="nav-link active">
                    MyCar
                </a>
            </li>
        </ul>
    ...
    <div class="container mt-5 pt-5">
        <div class="row d-flex flex-row">
            <?php
                ...
                $show = "SELECT * FROM showroom_fasma_table";
            ...
            <div class="card mx-1" style="width:18rem;">
                <img src="../asset/images/<?php echo $data['foto_mobil']?>" alt="foto" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title"><?= $data['nama_mobil']?></h5>
                    <p class="card-text"><?= $data['deskripsi']?></p>
                    <a class="btn btn-primary" href="Detail-fasma.php?id_mobil=<?php echo $data['id_mobil']?>">Detail</a>
                </div>
            </div>
            <?php }?>
            <?php }?>
