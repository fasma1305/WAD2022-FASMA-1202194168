...
<body>
    <nav class="navbar fixed-top navbar-expand-sm navbar-dark bg-dark">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item active">
                <a href="ListCar-Fasma.php" class="nav-link">
                    MyCar
                </a>
            </li>
            <li class="nav-item dropdown">
               ...
               <i class="far fa-user"></i> &nbsp; <?= $nama; ?>
                ...
                <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item text-primary" href="Fasma_profile.php"><i class="fas fa-user-edit"></i>&nbsp; Profile</a></li>
            ...
            <div>
                <div class="single-item">
                    <div class="row clearfix">
                            ...
                            <div class="deals-block-one">
                                <div class="inner-box">
                                    <div class="lower-content">
                                        <div class="title-text"><h1>SELAMAT DATANG DI SHOWROOM Fasma</h1></div>
                                        <p>Showroom terbaik di kota Bandung, terpercaya, dan aman.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                            <div class="image-box">
                                <figure class="image"><img src="https://hondaautobest.co.id/img/overview/bg_company.jpg" width="600" alt=""></figure>
                            </div>
                        </div>
                    </div>
                </div>
